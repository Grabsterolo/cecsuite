...
function ComisionesSection({ profile, userId, exchangeRate, mySales = [], allSales = [], onExchangeRateUpdated }) {
  const isAdmin = profile?.role === "admin";
  const isMobile = useIsMobile();
